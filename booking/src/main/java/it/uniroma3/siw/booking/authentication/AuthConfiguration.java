...
public class AuthConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
	        ...
	        .antMatchers(HttpMethod.GET, "/rooms/**").hasAnyAuthority(ADMIN_ROLE)
	        .antMatchers(HttpMethod.POST, "/rooms/**").hasAnyAuthority(ADMIN_ROLE)
	        .antMatchers(HttpMethod.GET, "/notBooked/**").hasAnyAuthority(ADMIN_ROLE)
	        .antMatchers(HttpMethod.POST, "/notBooked/**").hasAnyAuthority(ADMIN_ROLE)
	        //.antMatchers(HttpMethod.GET, "/rooms/add").hasAnyAuthority(ADMIN_ROLE)
	        //.antMatchers(HttpMethod.POST, "/rooms/add").hasAnyAuthority(ADMIN_ROLE)
